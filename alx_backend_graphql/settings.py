...
SECRET_KEY = 'django-insecure-_smozscpl=mpiv%5o6)@&mt90196h$g1$!qr9!$)tmg0%)v-5o'
...
INSTALLED_APPS = [
    ...
    'graphene_django',   # ✅ correct (with underscore, not dash!)
    'django_filters',    # ✅ needed for Task 3
    'crm',
]
